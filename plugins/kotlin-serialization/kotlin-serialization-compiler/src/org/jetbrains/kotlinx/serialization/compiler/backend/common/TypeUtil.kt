...
fun AbstractSerialGenerator.findTypeSerializerOrContextUnchecked(
    ...
    if (kType.isMarkedNullable) return findTypeSerializerOrContextUnchecked(module, kType.makeNotNullable(), annotations)
...
fun AbstractSerialGenerator.findTypeSerializerOrContext(
    ...
    return findTypeSerializerOrContextUnchecked(module, kType, annotations) ?: throw CompilationException(
